 ...
 * @author macbook
 */
public class RawatJalan extends javax.swing.JPanel {
   Koneksi conn = new Koneksi();
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        InputRawatJalan frminput=new InputRawatJalan();
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        try {
            ...
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin menghapus Data ini ??","Warning",2) == JOptionPane.YES_OPTION){
                String input = "delete from rawat_jalan where kd_rawat_jalan= '"+kode+"'";
                st= conn.getKoneksi().createStatement();
                int rsx = st.executeUpdate(input);
                if(rsx == 1){
                    input = "delete from rawat_jalan_biaya where kd_rawat_jalan= '"+kode+"'";
                    st= conn.getKoneksi().createStatement();
