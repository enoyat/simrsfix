...
public class Tindakan extends javax.swing.JPanel {
    ...
    public static void tampil() {
       try {
        ...
        while(rsx.next()) {
            ...
            data[1] = rsx.getString("kd_tindakan");
            data[2] = rsx.getString("nama_tindakan");
            data[3] = rsx.getString("tarif");
            dtm.addRow(data);
            i++;
        }
    ...
    public void cari() {
       try {
        ...
        while(rs.next()) {
            data[0] = String.valueOf(i);
            data[1] = rs.getString("kd_tindakan");
            data[2] = rs.getString("nama_tindakan");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        InputTindakan frminput=new InputTindakan();
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        if (baris>=0) {
            ...
            frminput.setVisible(true);
            frminput.aksi="edit";
            frminput.kd_tindakan.setText(gridtabel.getValueAt(baris, 1).toString());
            frminput.cari();            
        }
        else {
...
// TODO add your handling code here:
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        try {
            int baris=gridtabel.getSelectedRow();
            String kd_tindakan;
            kd_tindakan = gridtabel.getValueAt(baris, 1).toString();
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin menghapus Data ini ??","Warning",2) == JOptionPane.YES_OPTION){
                String input = "delete from tindakan where kd_tindakan= '"+kd_tindakan+"'";
