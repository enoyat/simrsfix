 ...
 * @author macbook
 */
public class Asuransi extends javax.swing.JPanel {
  Koneksi conn = new Koneksi();
    ...
    public static void tampil() {
       try {
        ...
        while(rsx.next()) {
            ...
            data[1] = rsx.getString("kd_asuransi");
            data[2] = rsx.getString("nama_asuransi");
            data[3] = rsx.getString("alamat");
            data[4] = rsx.getString("telpon");
            dtm.addRow(data);
            i++;
        }
    ...
    public void cari() {
       try {
           String sql = "SELECT * FROM asuransi where nama_asuransi like '%"+txtcari.getText()+"%'";
        ...
        while(rs.next()) {
            data[0] = String.valueOf(i);
            data[1] = rs.getString("kd_asuransi");
            data[2] = rs.getString("nama_asuransi");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cari data berdasarkan nama asuransi");
        ...
        gridtabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Kode", "Asuransi", "Alamat", "Telpon"
            }
        ));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        InputAsuransi frminput=new InputAsuransi();
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        if (baris>=0) {
           ...
           frminput.setVisible(true);
           frminput.aksi="edit";
           frminput.kd_asuransi.setText(gridtabel.getValueAt(baris, 1).toString());
           frminput.cari();           
        }
        else {
...
// TODO add your handling code here:
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        try {
            int baris=gridtabel.getSelectedRow();
            String kd_asuransi;
            kd_asuransi = gridtabel.getValueAt(baris, 1).toString();
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin menghapus Data ini ??","Warning",2) == JOptionPane.YES_OPTION){
                String input = "delete from asuransi where kd_asuransi= '"+kd_asuransi+"'";
