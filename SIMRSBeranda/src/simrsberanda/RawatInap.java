 ...
 * @author macbook
 */
public class RawatInap extends javax.swing.JPanel {
   Koneksi conn = new Koneksi();
    ...
    public static void tampil() {
       try {
        ...
        while(rsx.next()) {
            ...
            data[4] = rsx.getString("nama_ruang");      
            data[5] = rsx.getString("nama_dokter");      
    ...
    public void cari() {
       try {
        ...
        while(rs.next()) {
            ...
            data[4] = rs.getString("nama_ruang");      
            data[5] = rs.getString("nama_dokter");        
            dtm.addRow(data);
            i++;
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM RAWAT INAP");
        ...
        gridtabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Kode", "Pasien", "Tgl.Daftar", "Dokter", "Ruang"
            }
        ));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        InputRawatInap frminput=new InputRawatInap();
...
// TODO add your handling code here:
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        try {
            int baris=gridtabel.getSelectedRow();
            String kode;
            kode = gridtabel.getValueAt(baris, 1).toString();
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin menghapus Data ini ??","Warning",2) == JOptionPane.YES_OPTION){
                String input = "delete from rawat_inap where kd_rawat_inap= '"+kode+"'";
                st= conn.getKoneksi().createStatement();
                int rsx = st.executeUpdate(input);
                if(rsx == 1){
                    input = "delete from rawat_inap_biaya where kd_rawat_inap= '"+kode+"'";
                    st= conn.getKoneksi().createStatement();
                    rsx = st.executeUpdate(input);
