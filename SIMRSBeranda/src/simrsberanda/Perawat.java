 ...
 * @author macbook
 */
public class Perawat extends javax.swing.JPanel {
    Koneksi conn = new Koneksi();
    Statement st;
    ResultSet rs;
    public static void tampil() {
       try {
           String sql = "SELECT perawat.* FROM perawat";
        ...
        while(rsx.next()) {
            ...
            data[1] = rsx.getString("kd_perawat");
            data[2] = rsx.getString("nama_perawat");
            data[3] = rsx.getString("alamat_perawat");            
            dtm.addRow(data);
            i++;
        }
    ...
    public void cari() {
       try {
           String sql = "SELECT perawat.* FROM perawat where nama_perawat like '%"+txtcari.getText()+"%'";
        ...
        while(rs.next()) {
            data[0] = String.valueOf(i);
            data[1] = rs.getString("kd_perawat");
            data[2] = rs.getString("nama_perawat");
            data[3] = rs.getString("alamat_perawat");            
            dtm.addRow(data);
            i++;
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Formulir untuk entry data perawat");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        InputPerawat frminput=new InputPerawat();
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        if (baris>=0) {
          ...
          frminput.setVisible(true);
          frminput.aksi="edit";
          frminput.kd_perawat.setText(gridtabel.getValueAt(baris, 1).toString());
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        try {
            int baris=gridtabel.getSelectedRow();
            String kd_perawat;
            kd_perawat = gridtabel.getValueAt(baris, 1).toString();
            if(JOptionPane.showConfirmDialog(null, "Anda Yakin menghapus Data ini ??","Warning",2) == JOptionPane.YES_OPTION){
                String input = "delete from perawat where kd_perawat= '"+kd_perawat+"'";
